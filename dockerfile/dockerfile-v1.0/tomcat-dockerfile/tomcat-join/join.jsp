<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="java.sql.*" %>
        <%@ page import="javax.sql.*" %>
            ...
            <body>
                <% String id=request.getParameter("id"); String password=request.getParameter("password"); String
                    address=request.getParameter("address"); String phone=request.getParameter("phone"); if
                    (request.getMethod().equalsIgnoreCase("post")) { if (id==null || id.isEmpty() || password==null ||
                    password.isEmpty()) { out.println("<script>alert('ID와 Password는 필수 입력 항목입니다.'); </script>");
                    } else {
                    ...
                    String jdbcUrl =
                    "jdbc:mysql://hf-database20240924062744984300000001.cn482mka8n93.ap-northeast-2.rds.amazonaws.com:3306/test";
                    String dbUser = "hf";
                    String dbPass = "1234";
