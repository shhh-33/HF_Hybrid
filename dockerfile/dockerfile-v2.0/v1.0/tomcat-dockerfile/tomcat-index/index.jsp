                            ...
                            <%@ page import="javax.servlet.http.HttpServletResponse" %>
                                <%@ page import="javax.servlet.http.HttpSession" %>
                                    <%@ page import="java.util.*" %>
                                        ...
                                        <% // 세션에서 사용자 역할을 가져옴 String userId=(String) session.getAttribute("userId");
                                                ...
                                                <div class="container">
                                                    <div class="hero__slider owl-carousel">
                                                        <div class="hero__items set-bg"
                                                            data-setbg="data/img/homepage/cgv.png">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                        ...
                                                        <div class="hero__items set-bg"
                                                            data-setbg="data/img/homepage/lotte.png">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="hero__text">
                                                        ...
                                                        <div class="hero__items set-bg"
                                                            data-setbg="data/img/homepage/megabox.png">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="hero__text">
